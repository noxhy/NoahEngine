...
func _ready() -> void:
	...
	update_selection(Global.static_values.get("selected_difficulty", 0))
...
func _process(_delta: float) -> void:
	if can_press:
		if Input.is_action_just_pressed("menu_left"):
			update_selection(Global.static_values["selected_difficulty"] - 1)
...
func update_selection(i: int):
	Global.static_values["selected_difficulty"] = wrapi(i, 0, difficulties.size())
	i = Global.static_values["selected_difficulty"]
...
func update_separators():
	...
	var difficulty = difficulties[Global.static_values["selected_difficulty"]]
